...
class PortfolioManager:
    ...
    def get_total_equity(self) -> float:
        """Return available_cash + cumulative realized P&L from closed positions.

        Note: open positions are marked-to-market via their daily_marks;
        the equity_curve records total equity including unrealized P&L.
        """
